...
function sendArtificialPageView() {
  window._uxa = window._uxa || [];
  window._uxa.push(['setQuery', location.search + (location.search ? '&' : '?') + 'cs-chat']);
...
function setListeners (){
  if(document.getElementById('dummy-chat-button-iframe')){
    document.getElementById('dummy-chat-button-iframe').contentWindow.document.getElementById('dummy-chat-button').addEventListener("click", sendArtificialPageView, false);
  }
  else{
